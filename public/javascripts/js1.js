...
$('.calculate').click(function() {
	...
	if (checked) {
		baseballFact = '<div class="baseballFact"><div class="d-flex justify-content-center"><p>In the same weekend, <span id="bold">' + westyPlayer[westyRand]["Name"] + '</span> also had</p></div><div class="d-flex justify-content-center"><span id="number">' + westyPlayer[westyRand][chosenStat] + '</span></div></div>'
	} 
